...
u235 = openmc.Material(name='U-235')
u235.add_nuclide('U235', 1.0)
u235.set_density('g/cm3', config['fuel_density'])  
...
u235_cell = openmc.Cell(fill=u235, region=-sphere)

universe = openmc.Universe(cells=[hdpe_cell, u235_cell])
geometry = openmc.Geometry(universe)

source_lib = "/global/scratch/users/toniooppi/Nuclear_stuff/Cpp_experiment/U235_source/build/libu235_source.so"
