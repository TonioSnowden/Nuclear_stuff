...
pu238 = openmc.Material(name='Pu-238')
pu238.add_nuclide('Pu238', 1.0)
pu238.set_density('g/cm3', config['fuel_density'])  
...
pu238_cell = openmc.Cell(fill=pu238, region=-sphere)

universe = openmc.Universe(cells=[hdpe_cell, pu238_cell])
geometry = openmc.Geometry(universe)

source_lib = "/global/scratch/users/toniooppi/Nuclear_stuff/Cpp_experiment/Pu238_source/build/libpu238_source.so"
